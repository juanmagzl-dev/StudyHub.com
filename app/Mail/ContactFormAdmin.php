...
/**
 * Clase para enviar notificaciones por correo al administrador cuando se recibe
 * un mensaje desde el formulario de contacto
 */
class ContactFormAdmin extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Nuevo mensaje de contacto - StudyHub',
        );
    }
